...
2. gets all registered (non-removed) charities from charity commission data to serve as potential recipients
3. builds a database of funders, grants and recipients using the charity commission and 360 giving apis
4. builds a database of grants and recipients using pdfs of official charity accounts
5. eda - explores and visualises the data
